...
define(["underscore", "marionette", "hammer", "animationFrame"], function (_, Marionette, Hammer, AnimationFrame) {
    'use strict';
     ...
     */
    var GestureHelper = Marionette.Object.extend({
        /**
         * initialize(options)
        ...
        initialize: function (options) {
            //myLogger.trace("GestureHelper - initialize");
            this.el = options.el;
        ...
        onSwipe: function (event) {
            //var angle = 50;
            //transform.ry = (event.direction & Hammer.DIRECTION_HORIZONTAL) ? 1 : 0;
            //transform.rx = (event.direction & Hammer.DIRECTION_VERTICAL) ? 1 : 0;
            //transform.angle = (event.direction & (Hammer.DIRECTION_RIGHT | Hammer.DIRECTION_UP)) ? angle : -angle;
            //
